...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 09 juil. 2019 à 13:38
...
--
-- Base de données :  `utc_aurelien`
--
CREATE DATABASE IF NOT EXISTS `utc_aurelien` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `utc_aurelien`;
